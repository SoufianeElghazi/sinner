    ...
    <Card className="quote-card-view">
      <Card.Body>
        ...
        <p style={{ textAlign: "justify" }}>
            ...
            <span className="other_color"> Data Analyst and Data Engineer </span> with a strong drive for innovation and problem-solving. 
            ...
            <span className="other_color"> Playing Chess</span>, <span className="other_color"> Basketball</span>, and <span className="other_color"> Football</span>, 
